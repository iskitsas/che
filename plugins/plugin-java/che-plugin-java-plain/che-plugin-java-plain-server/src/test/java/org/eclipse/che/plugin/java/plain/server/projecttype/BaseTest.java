...
public abstract class BaseTest {
    ...
    BaseTest() {
        javaPlugin = new JavaPlugin(wsPath + "/set", null, null);
    ...
    FolderEntry createTestProject() throws ServerException, NotFoundException, ConflictException, ForbiddenException {
